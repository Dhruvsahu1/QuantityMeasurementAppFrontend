...
export default function Login() {
  ...
  const { login, googleLogin, setUserFromOAuth } = useAuth();
  ...
  useEffect(() => {
    ...
    if (oauthToken && oauthEmail) {
      setUserFromOAuth(oauthToken, decodeURIComponent(oauthEmail));
      ...
      >
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-moss text-gray-500">or continue with</span>
          </div>
        </div>
